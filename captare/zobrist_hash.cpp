...
namespace chess
{
	...
	uint64_t zobrist_hash::random64[random64_length] =
	{
		#pragma region random64 data
	...
	std::span<uint64_t, zobrist_hash::piece_length> zobrist_hash::random64_piece{ &random64[0], piece_length};
	std::span<uint64_t, zobrist_hash::castle_length> zobrist_hash::random64_castle{ &random64[castle_offset], castle_length };
	std::span<uint64_t, zobrist_hash::ep_length> zobrist_hash::random64_ep{ &random64[ep_offset], ep_length };
	std::span<uint64_t, zobrist_hash::turn_length> zobrist_hash::random64_turn{ &random64[turn_offset], turn_length };

	uint64_t zobrist_hash::castle_hash_map[castle_hash_map_length] =
	{
		0ULL,
		random64_castle[0],
		random64_castle[1],
		random64_castle[0] ^ random64_castle[1],
		random64_castle[2],
		random64_castle[0] ^ random64_castle[2],
		random64_castle[1] ^ random64_castle[2],
		random64_castle[0] ^ random64_castle[1] ^ random64_castle[2],
		random64_castle[3],
		random64_castle[0] ^ random64_castle[3],
		random64_castle[1] ^ random64_castle[3],
		random64_castle[0] ^ random64_castle[1] ^ random64_castle[3],
		random64_castle[2] ^ random64_castle[3],
		random64_castle[0] ^ random64_castle[2] ^ random64_castle[3],
		random64_castle[1] ^ random64_castle[2] ^ random64_castle[3],
		random64_castle[0] ^ random64_castle[1] ^ random64_castle[2] ^ random64_castle[3]
	};

	uint64_t zobrist_hash::turn_hash_map[turn_hash_map_length] = { random64_turn[0], 0ULL };
}
